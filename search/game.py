...
class GameStateData:
    ...
    """
    def __init__( self, prevState = None ):#gameStateData: nhận vào 1 data trước đó
        """
        Generates a new data packet by copying information from its predecessor.
        """
        if prevState != None:
            self.food = prevState.food.shallowCopy()
            self.capsules = prevState.capsules[:] # trả về 1 bảng copy của capsules. Bảng này sẽ không tham chiếu đến bảng gốc
